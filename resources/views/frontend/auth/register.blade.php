    ...
    <div class="row d-flex justify-content-center align-items-center">
      ...
      >
        <div class="card-body p-3">
          <h1 class="h3 text-center text-gray-800 fw-bold mb-4">{{ __('Sign Up') }}</h1>
          <form action="{{ route('register') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input
                  type="text"
                  class="form-control @error('name') not-valid @enderror"
                  value="{{ old('name') }}"
                  autocomplete="name"
                  autofocus
                  name="name"
                  aria-label="name"
                />
                @error('name') <span class="text-red-500" style="font-size: 14px">{{ $message }}</span> @enderror
              </div>
            <div class="mb-3">
          ...
          <div class="d-flex justify-content-center my-3">
              ...
              <span class="text-gray-400">or signup with</span>
              <span class="border-2 border-gray-300 border-bottom mb-2 mx-2 w-25"></span>
          </div>
